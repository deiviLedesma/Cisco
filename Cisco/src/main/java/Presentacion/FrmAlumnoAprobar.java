...
public class FrmAlumnoAprobar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtMinutos.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        txtMinutos.setText("XX");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAlumnoAprobar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAlumnoAprobar().setVisible(true);
            }
        });
    }
